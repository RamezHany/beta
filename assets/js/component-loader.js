               ...
               <div class="tp-footer-2-widget footer-col-2-1">
                  ...
                  <div class="tp-footer-2-widget-text">
                     ...
                     <div class="tp-footer-2-contact-item mt-3">
                        <span><a href="tel:+201220117832" style="color: #FFD700; text-decoration: none;">📞 +201288640058</a></span>
                     </div>                        
                  </div>
               </div>
            </div>
               ...
               <div class="tp-footer-2-widget footer-col-2-4">
                  <div class="tp-footer-2-widget-newslatter">
                     ...
                     <form id="newsletter-form">
                        ...
                        <div id="newsletter-message" style="margin-top: 10px; color: #FFD700; font-size: 14px;"></div>
                     </form>
                  </div>
               </div>
            </div>
